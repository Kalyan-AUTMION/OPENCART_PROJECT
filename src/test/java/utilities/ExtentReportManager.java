...
public class ExtentReportManager implements ITestListener {
    ...
    public void onTestFailure(ITestResult result) {
        ...
        if (imgPath != null && !imgPath.isEmpty()) {
            try {
                ...
                e.printStackTrace();
                test.log(Status.ERROR, "Failed to attach screenshot to report");
            }
        } else {
            System.out.println("Screenshot path is null or empty for " + result.getName());
        }
    }
    ...
    public void onFinish(ITestContext testContext) {
        ...
        /* Uncomment the below block to enable sending the report via email
        try {
